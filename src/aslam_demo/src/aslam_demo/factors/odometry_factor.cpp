...
/* ************************************************************************* */
OdometryFactor::OdometryFactor(gtsam::Key key1, gtsam::Key key2, const gtsam::Pose2& measurement, const gtsam::noiseModel::Base::shared_ptr& model)
    : Base(key1, key2, measurement, model) {
}

/* ************************************************************************* */
void OdometryFactor::print(const std::string& title, const gtsam::KeyFormatter& keyFormatter) const {
...
/* ************************************************************************* */
std::ostream& operator<<(std::ostream& stream, const OdometryFactor& factor) {
